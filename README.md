...
- **Places I've Been:** a card on the home page (and the icon next to the logo) opens a region picker: an "All" card plus Europe, Asia, Africa, North America, South America and Oceania, each with its own emoji and how many of its countries you've ticked off. Tick Been or Want to Go for any country; any country on an active trip's itinerary shows as Been automatically, no need to tick it yourself. Filter the whole page down to just Been or Want to Go, with a live count next to each filter. Each country shows its capital, language and a "Search Flights" link out to Google Flights. Includes England, Scotland, Wales and Northern Ireland as their own entries, not lumped into a single United Kingdom.
