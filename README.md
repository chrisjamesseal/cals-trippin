...
- **Itinerary** — plan out each day: add a place by name and it appears with an embedded Google Map, a time, a type (food, sight, night out…) and a note on why it made the list. Ideas pins get an "Open in Maps" link too.
